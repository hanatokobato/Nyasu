...
const Chart = ({ wordLevels }: IProps) => {
  ...
  const heights = {
    level_1:
      totalWords === 0 || (wordLevels.level_1 / totalWords) * 320 < minHeight
        ? minHeight
        : (wordLevels.level_1 / totalWords) * 320,
    level_2:
      totalWords === 0 || (wordLevels.level_2 / totalWords) * 320 < minHeight
        ? minHeight
        : (wordLevels.level_2 / totalWords) * 320,
    level_3:
      totalWords === 0 || (wordLevels.level_3 / totalWords) * 320 < minHeight
        ? minHeight
        : (wordLevels.level_3 / totalWords) * 320,
    level_4:
      totalWords === 0 || (wordLevels.level_4 / totalWords) * 320 < minHeight
        ? minHeight
        : (wordLevels.level_4 / totalWords) * 320,
    level_5:
      totalWords === 0 || (wordLevels.level_5 / totalWords) * 320 < minHeight
        ? minHeight
